...
(function (root) {
    ...
    function renderSavedViewsIndex(views, container) {
        ...
        const rowsHtml = list.length
                      ...
                      return `
                        <div class="project-card saved-views-page__list-item">
                            ...
                            <div class="saved-views-page__row-actions">
                                <a class="ribbon-btn ribbon-btn--sm" href="${path}">Open</a>
                                <button type="button" class="ribbon-btn ribbon-btn--sm" data-sv-edit="${idAttr}">Edit</button>
                                <button type="button" class="ribbon-btn ribbon-btn--sm" data-sv-delete="${idAttr}">Delete</button>
                            </div>
                        </div>`;
                  })
                  .join('')
            : `<p class="meta-row saved-views-page__empty">No Saved Views yet.</p>
               ...
               <p><button type="button" class="ribbon-btn" id="prks-saved-views-empty-search">Search or jump</button></p>`;
        container.innerHTML = `
    ...
    function renderSavedViewNotFound(container) {
        container.innerHTML = `
            ...
            <p class="meta-row"><a class="ribbon-btn" href="#/views">Back to Saved Views</a></p>
        `;
    }
                ...
                <div class="page-header">
                    <div class="page-header__title-row">
                        ...
                        <div class="page-header__actions">
                            <a class="ribbon-btn" href="${esc(searchHash)}">Open as Search</a>
                            <button type="button" class="ribbon-btn" id="prks-saved-view-edit">Edit</button>
                            <button type="button" class="ribbon-btn" id="prks-saved-view-delete" data-sv-delete="${idAttr}">Delete</button>
                        </div>
                    </div>
                </div>
                ${cards}
