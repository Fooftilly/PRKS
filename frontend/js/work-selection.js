...
(function (root) {
    ...
    function ensureToolbar() {
        ...
        bar.innerHTML =
            ...
            '<button type="button" class="ribbon-btn ribbon-btn--sm" data-bulk-open="status">Status</button>' +
            '<button type="button" class="ribbon-btn ribbon-btn--sm" data-bulk-open="folder">Folder</button>' +
            '<button type="button" class="ribbon-btn ribbon-btn--sm" data-bulk-open="tags">Tags</button>' +
            '</div>' +
            '<button type="button" class="ribbon-btn ribbon-btn--sm prks-bulk-toolbar__organize" data-bulk-open="organize">Organize…</button>' +
            '<button type="button" class="ribbon-btn ribbon-btn--sm" data-bulk-select-all>Select all visible</button>' +
            '<button type="button" class="ribbon-btn ribbon-btn--sm" data-bulk-clear>Clear</button>' +
            '<button type="button" class="ribbon-btn ribbon-btn--sm prks-bulk-toolbar__exit" data-bulk-exit aria-label="Exit selection">&times;</button>';
    ...
    function renderOrganizeBody() {
        return (
            ...
            '<button type="button" class="add-new-btn" data-bulk-open="status">Status</button>' +
            '<button type="button" class="add-new-btn" data-bulk-open="folder">Folder</button>' +
            '<button type="button" class="add-new-btn" data-bulk-open="tags">Tags</button>' +
            '</div>'
        );
    }
