...
- **Research Notes and Work reminders (the private notes on a file) work offline.** Each is one whole document with its own revision. Editing one never conflicts with the other. Folder reminders still need a connection.
