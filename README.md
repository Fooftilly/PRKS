...
- **Deleting** a Person requires a connection, and editing which files they are linked to from the profile page requires one too. Creating a Person, editing a profile and changing their groups do not — see below.
