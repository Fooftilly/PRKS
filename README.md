...
- The rest of that editor (title, status, document type, year and the publication dates) still saves on the PRKS server. While you are offline its **Save Changes** button is disabled and says so, rather than letting you type into a form that cannot save.
