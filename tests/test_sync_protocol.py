    ...
    def test_registered_families(self):
        self.assertEqual(sorted(sync_protocol.supported_operations()),
                         [
                          ...
                          "CREATE_CONCEPT", "CREATE_FOLDER", "CREATE_PERSON",
                          "CREATE_PERSON_GROUP", "CREATE_PLAYLIST", "CREATE_POSITION",
                          "CREATE_TAG", "DELETE_CONCEPT", "DELETE_FOLDER",
                          ...
                          "REORDER_PLAYLIST_ITEMS", "SET_CONCEPT_FIELD", "SET_CONCEPT_IDENTITY",
